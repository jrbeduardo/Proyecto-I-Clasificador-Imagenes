...
## API de Inferencia y Frontends

### 1. API de Clasificación (`app/`)
El proyecto integra una API REST desarrollada en **FastAPI** encargada de procesar las imágenes de comida usando un modelo **Vision Transformer (ViT-B/16)** fine-tuneado sobre el dataset Food-101. Adicionalmente, cuenta con integración con la API de **Google Gemini** para enriquecer las predicciones con recomendaciones e información nutricional detallada.
Para instrucciones de despliegue local o con Docker, revisa la [documentación de la API](app/README.md).

### 2. Frontends Generados por IA (Vibe Coding)
El proyecto incluye diferentes clientes web funcionales (como `frontend_gemimi_cli`, `frontend2`, etc.) alojados en la raíz que permiten consumir e interactuar con la API. Varios de estos frontends fueron construidos al 100% bajo la metodología de **Vibe Coding**, en donde una Inteligencia Artificial generó todo el código (HTML, CSS, JS) basándose únicamente en prompts y lenguaje natural.
Si deseas ver cómo fue generado el código o probar los frontends localmente, visita el [README de Frontends por Vibe Coding](README_FRONTENDS_VIBE_CODING.md).
...
| vit_b16_cifar10_finetune.ipynb | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-181717?logo=github&logoColor=white)](notebooks/vit_b16_cifar10_finetune.ipynb) | [![Abrir en Colab](https://img.shields.io/badge/Abrir%20en-Colab-F9AB00?logo=googlecolab&logoColor=white)](https://colab.research.google.com/github/jrbeduardo/Proyecto-I-Clasificador-Imagenes/blob/main/notebooks/vit_b16_cifar10_finetune.ipynb) |
| vit_b16_food101_finetune.ipynb | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-181717?logo=github&logoColor=white)](notebooks/vit_b16_food101_finetune.ipynb) | [![Abrir en Colab](https://img.shields.io/badge/Abrir%20en-Colab-F9AB00?logo=googlecolab&logoColor=white)](https://colab.research.google.com/github/jrbeduardo/Proyecto-I-Clasificador-Imagenes/blob/main/notebooks/vit_b16_food101_finetune.ipynb) |
| vit_b16_food101_load.ipynb | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-181717?logo=github&logoColor=white)](notebooks/vit_b16_food101_load.ipynb) | [![Abrir en Colab](https://img.shields.io/badge/Abrir%20en-Colab-F9AB00?logo=googlecolab&logoColor=white)](https://colab.research.google.com/github/jrbeduardo/Proyecto-I-Clasificador-Imagenes/blob/main/notebooks/vit_b16_food101_load.ipynb) |
...
| Notebook | GitHub | Colab |
|---|---|---|
| clip_texto_imagen.ipynb | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-181717?logo=github&logoColor=white)](notebooks/clip_texto_imagen.ipynb) | [![Abrir en Colab](https://img.shields.io/badge/Abrir%20en-Colab-F9AB00?logo=googlecolab&logoColor=white)](https://colab.research.google.com/github/jrbeduardo/Proyecto-I-Clasificador-Imagenes/blob/main/notebooks/clip_texto_imagen.ipynb) |
| comparar_dos_imagenes_embeddings.ipynb | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-181717?logo=github&logoColor=white)](notebooks/comparar_dos_imagenes_embeddings.ipynb) | [![Abrir en Colab](https://img.shields.io/badge/Abrir%20en-Colab-F9AB00?logo=googlecolab&logoColor=white)](https://colab.research.google.com/github/jrbeduardo/Proyecto-I-Clasificador-Imagenes/blob/main/notebooks/comparar_dos_imagenes_embeddings.ipynb) |
...
| red_siamesa_tenis.ipynb | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-181717?logo=github&logoColor=white)](notebooks/red_siamesa_tenis.ipynb) | [![Abrir en Colab](https://img.shields.io/badge/Abrir%20en-Colab-F9AB00?logo=googlecolab&logoColor=white)](https://colab.research.google.com/github/jrbeduardo/Proyecto-I-Clasificador-Imagenes/blob/main/notebooks/red_siamesa_tenia_tenis.ipynb) |
